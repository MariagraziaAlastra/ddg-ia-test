    ...
    casper.viewport(360, 640).then(function() {
        casper.reload(function() {
            ...
            if(path.match(/no-tiles/)) {
                ...
                casper.test.comment("Check if tileview exists and it's a grid");
                casper.test.assertExists((root_selectors.main + " " + root_selectors.tiles.tileview_grid), "Tileview exists and it's a grid");
